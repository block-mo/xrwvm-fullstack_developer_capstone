...
app.get("/fetchDealers", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "An error occured while fetching dealerships" });
  }
});
...
app.get("/fetchDealers/:state", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "An error occurred while fetching dealerships by state" });
  }
});
...
app.get("/fetchDealer/:id", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .send({ message: "Error fetching dealer", error: error.message });
  }
});
